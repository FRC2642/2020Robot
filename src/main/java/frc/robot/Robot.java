...
public class Robot extends TimedRobot {
  ...
  /*
   * public boolean pipelineRan = false; // lets us know when the pipeline has
   * actually run public double angleToTape = 0; public double distanceToTape = 0;
   */
  /*
